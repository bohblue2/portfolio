...
from .event import KWApiConnector

class Kiwoom(QAxWidget, KWApiConnector): # 상속됨 KWapiConnector
    ...
    def _receive_tr_data(self, sScrNo, sRQName, sTrCode, sRecordName, sPreNext,
        ...
        getattr(self, f'_{sRQName.split("_")[0]}', lambda a, b: None)(sRQName, sTrCode)
